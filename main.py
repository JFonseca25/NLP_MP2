...
def main():
	...
	nb_model_cv_3 = NaiveBayes(corpus, vectorizer=CountVectorizer(stop_words='english', ngram_range=(1, 3)))
	
	nb_model_tfidf_1 = NaiveBayes(corpus)
	nb_model_tfidf_2 = NaiveBayes(corpus, vectorizer=TfidfVectorizer(tokenizer=LemmaTokenizer()))
	nb_model_tfidf_3 = NaiveBayes(corpus, vectorizer=TfidfVectorizer(stop_words='english', ngram_range=(1, 3)))
	...
	print("NB CV 1 -> ", accuracy_score(true_labels, nb_model_cv_1.predict(test_ds)))
	print("NB CV 2 (lemmatization) -> ", accuracy_score(true_labels, nb_model_cv_2.predict(test_ds)))
	print("NB CV 3 (1,3)-gram -> ", accuracy_score(true_labels, nb_model_cv_3.predict(test_ds)))
	print("NB tf-idf 1 -> ", accuracy_score(true_labels, nb_model_tfidf_1.predict(test_ds)))
	print("NB tf-idf 2 (lemmatization) -> ", accuracy_score(true_labels, nb_model_tfidf_2.predict(test_ds)))
	print("NB tf-idf 3 (1,3)-gram -> ", accuracy_score(true_labels, nb_model_tfidf_3.predict(test_ds)))

	print("KNN CV 1 -> ", accuracy_score(true_labels, knn_model_cv_1.predict(test_ds)))
	print("KNN CV 2 (lemmatization) -> ", accuracy_score(true_labels, knn_model_cv_2.predict(test_ds)))

	print("KNN tf-idf 1 -> ", accuracy_score(true_labels, knn_model_tfidf_1.predict(test_ds)))
	print("KNN tf-idf 2 (lemmatization) -> ", accuracy_score(true_labels, knn_model_tfidf_2.predict(test_ds)))
